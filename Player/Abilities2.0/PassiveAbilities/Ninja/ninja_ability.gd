...
func on_equipped() -> void:
	...
	PlayerManager.player.stats.perfect_shot_bonus.add_buff(6770, -0.2, Stat.buff_type.MULTIPLICATIVE)
...
func on_unequipped() -> void:
	...
	PlayerManager.player.stats.perfect_shot_bonus.remove_buff_stack(6770, Stat.buff_type.MULTIPLICATIVE)
