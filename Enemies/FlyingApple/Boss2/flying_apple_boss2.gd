class_name FlyingBlueAppleBoss extends FlyingApple

@onready var enemy_state_machine: EnemyStateMachine = $EnemyStateMachine
@onready var shoot_timer: Timer = $ShootTimer
@onready var pre_ability_location: Area2D = $PreAbilityLocation

const MINI_ENEMY = preload("res://Enemies/FlyingApple/FlyingApple.tscn")
...
func summon() -> void:
	...
	var new_summon: FlyingApple = MINI_ENEMY.instantiate()
